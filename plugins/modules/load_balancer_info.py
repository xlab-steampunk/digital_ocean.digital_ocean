...
- digital_ocean.digital_ocean.common
...
- name: Gather information about all load balancers
  digital_ocean.digital_ocean.load_balancer_info:
...
from ..module_utils.digital_ocean import DigitalOceanHelper
...
def main():
    ...
    if module._name == 'digital_ocean.digital_ocean.load_balancer_facts':
